...
<html lang="en">
  ...
  <div>
      ...
      <p>Acesse o painel para controlar as informações do seu negócio.</p>
      ...
      <form action="logarAdminServlet" method="post">
          ...
          <!-- PAGINA DE REACT DO 2o ANO -->
          <a href="https://react-save-it.vercel.app/" target="_blank">Entrar como admin do App</a>
      </form>
