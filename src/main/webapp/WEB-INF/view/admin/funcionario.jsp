...
<html lang="en">
  ...
  <div class="adicionar-funcionario">
    <form action="" method="post">
      ...
      <div class="inputs">
        <label for="">Nome
          <input type="text" placeholder="Digite o nome" name="inputNome" id="inputNome" />
        </label>
        <label for="">Cargo
        ...
        <label for="">CPF
          <input type="text" placeholder="Digite o CPF" name="inputCpf" id="inputCpf" />
        </label>
        <label for="">RG
          <input type="text" placeholder="Digite o RG" name="inputRg" id="inputRg" />
        </label>
      </div>
      <hr>
    ...
    <form action="" method="post">
      ...
      <div>
        ...
        <div>
          <label for="inputFile2">
            <i class="ri-upload-2-line"></i>Enviar Foto
            <input type="file" name="inputFile2" id="inputFile2" accept=".jpg, .png, .jpeg" 1qaa />
          </label>
        </div>
      </div>
      ...
      <div class="inputs">
        <label for="">Nome Completo
          <input type="text" placeholder="Digite o nome" name="inputNome2" id="inputNome2" />
        </label>
        <label for="">Data de Contratação
          <input type="text" placeholder="Data de contratação" name="inputDataContratacao" id="inputDataContratacao" />
        </label>
        ...
        <label for="">CPF
          <input type="text" placeholder="Digite o CPF" name="inputCpf2" id="inputCpf2" />
        </label>
        <label for="">RG
          <input type="text" placeholder="Digite o RG" name="inputRg2" id="inputRg2" />
        </label>
      </div>
      <hr>
      <div class="acoesForm">
