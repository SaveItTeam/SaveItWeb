...
<body>
    ...
    <nav>
      <ul>
        ...
        <div>
          ...
          <li id="pagamento">
            <a href="#"><i class="ri-bank-card-fill"></i>
            </a>
        ...
        <li id="settings">
          <a href="configuracoes.html"><i class="ri-settings-3-fill"></i></a>
        </li>
      </ul>
    </nav>
  ...
  <div class="adicionar-funcionario">
    <form action="" method="post">
      ...
      <div class="inputs">
        ...
        <label for="">Data de Contratação
          <input type="date" placeholder="Digite a data de contratação" name="inputStatus" id="inputStatus" />
        </label>
        <label for="">Estado
        ...
        <label for="">Cidade
          <input type="text" placeholder="Digite a cidade" name="inputCidade" id="inputCidade">
        </label>

        <label for="">CEP
          <input type="text" placeholder="Digite o CEP" name="inputCEP" id="inputCEP">
        </label>

        <label for="">Bairro
          <input type="text" placeholder="Digite o Bairro" name="inputBairro" id="inputBairro">
        </label>

        <label for="">Rua
          <input type="text" placeholder="Digite a Rua" name="inputRua" id="inputRua">
        </label>
      </div>
      ...
      <div class="acoesForm">
        ...
        <button type="submit" id="adicionarFuncionario">
  ...
  <div class="editar-funcionario">
    <form action="" method="post">
      ...
      <div class="inputs">
        ...
        <label for="">Estado
          <select name="selectEstado" id="selectEstado2">
            <option value="AC">AC</option>
            <option value="AL">AL</option>
            <option value="AM">AM</option>
            <option value="AP">AP</option>
        ...
        <label for="">Cidade
          <input type="text" placeholder="Digite a cidade" name="inputCidade" id="inputCidade2">
        </label>

        <label for="">CEP
          <input type="text" placeholder="Digite o CEP" name="inputCEP" id="inputCEP2">
        </label>

        <label for="">Bairro
          <input type="text" placeholder="Digite o Bairro" name="inputBairro" id="inputBairro2">
        </label>

        <label for="">Rua
          <input type="text" placeholder="Digite a Rua" name="inputRua" id="inputRua2">
        </label>
      </div>
      <div class="acoesForm">
 ...
 <script src="${pageContext.request.contextPath}/assets/js/funcionario.js"></script>
