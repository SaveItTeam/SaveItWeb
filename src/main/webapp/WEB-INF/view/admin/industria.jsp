...
<head>
    ...
    <title>Indústria - Essentia</title>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/global.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/industria.css">
...
<body>
   ...
   <%@include file="../../../assets/sidebar.jsp"%>
    ...
    <main>
        <section id="industria-principal">
            ...
            <form action="">
                <div>
                    <div>
                        <label for="inputNome">Nome do Negócio
                            <input type="text" name="inputNome" id="inputNome" placeholder="Digite o nome do negócio">
                        </label>
                        <label for="inputCnpj">
                            CNPJ
                            <input type="text" name="inputCnpj" id="inputCnpj" placeholder="Digite o CPF">
                        </label>
                        <label for="selectEstado">Estado
                        ...
                        <label for="inputCidade">Cidade
                            <input type="text" name="inputCidade" id="inputCidade" placeholder="Digite a cidade">
                        </label>
                        <label for="inputCep">CEP
                            <input type="text" name="inputCep" id="inputCep" placeholder="Digite o CEP">
                        </label>
                        <label for="inputBairro">Bairro
                            <input type="text" name="inputBairro" id="inputBairro" placeholder="Digite o bairro">
                        </label>
                    </div>
                    ...
                    <div>
                        ...
                        <label for="inputContato">Contato
                            <input type="tel" name="inputContato" id="inputContato" placeholder="Digite o telefone">
                        </label>

                        <label for="inputOperacao">Tipo de Operação
                            <input type="text" name="inputOperacao" id="inputOperacao"
                                placeholder="Digite o tipo de operação">
                        </label>

                        <label for="inputRua">Rua
                            <input type="text" name="inputRua" id="inputRua" placeholder="Digite a rua">
                        </label>

                        <label for="inputComplemento">Complemento (opcional)
                            <input type="text" name="inputComplemento" id="inputComplemento"
                ...
                <div id="categorias-industria">
                    <div>
                        ...
                        <button id="fechar-categorias"><i class="ri-close-line"></i></button>
                    </div>
                    ...
                    <ul>
                        <label>
                            <input type="checkbox" name="categorias-checkbox">
                            Laticínios
                        </label>
    ...
    <script src="${pageContext.request.contextPath}/assets/js/industria.js"></script>
</body>
</html>