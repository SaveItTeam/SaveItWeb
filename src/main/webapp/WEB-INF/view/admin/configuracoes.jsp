<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    ...
    <head>
        ...
        <link rel="shortcut icon" href="${pageContext.request.contextPath}/assets/images/favicon_essentia.png"
            type="image/x-icon">
            ...
            <form action="" method="post">
                ...
                <div class="inputs">
                    ...
                    <label for="">Último Nome
                        <input type="text" placeholder="Digite o último nome" name="inputUltimoNome"
                            id="inputSegNome" />
                    </label>
                    <!-- <label for="">ID
