...
<main>
    <div class="header">
        ...
        <div class="administrador">
            <img src="<%=session.getAttribute("img")%>" alt="Foto do Administrador" />
            <div>
    ...
    <section id="configuracoes">
        ...
        <div id="configuracoes-principal">
            <form method="post" action="alterarConfiguracoesServlet" enctype="multipart/form-data">
                <div id="imagem-container">
                    <img src="<%=session.getAttribute("img_funcionario")%>" alt="Imagem do Usuário" id="imgPreviewUser">
                    <label for="inputFile" style="display: none;">
                ...
                <div id="senhas-extra" style="display: none">
                    ...
                    <div class="password-container">
                        ...
                        <button
                                ...
                                data-target="inputSenhaAntiga"
                        >
                            <i class="ri-eye-line"></i>
                        </button>
                    </div>

                    <label for="inputSenhaNovaConfirmar">Nova Senha</label>
                    <div class="password-container">
                        <input
                                type="password"
                                id="inputSenhaNovaConfirmar"
                                name="inputSenhaNovaConfirmar"
                        ...
                        <button
                                type="button"
                                class="toggle-password"
                                data-target="inputSenhaNovaConfirmar"
                        >
                            <i class="ri-eye-line"></i>
                        </button>
                    </div>
            ...
            <div id="contato">
                ...
                <a href="mailto:essentia.saveit@gmail.com"
                ><i class="ri-mail-fill"></i>essentia.saveit@gmail.com</a
                >
            </div>
        </div>
    </section>
