let input = document.querySelector("#input-usuario input");
let botaoSend = document.querySelector("#input-usuario button");
...
function scrollParaBaixo() {
    setTimeout(() => {
        divMensagens.scrollTop = divMensagens.scrollHeight - 200;
    }, 100);
}
